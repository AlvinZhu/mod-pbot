...
public:
    ...
    void ClearTeleport();
    void Update(uint32 diff, BotAIMovement* pMovement);
...
{
public:
    BotAIHorrorState(Player* self);
    ~BotAIHorrorState() {}

    void UpdateHorror(uint32 diff, BotAIMovement* movement);

    Position GetNewHorrorPos();
    static Position GetNewHorrorPosByRange(Player* player, float distance);
    Position FindNewHorrorPos(BotAIMovement* movement);
...
public:
    ...
    bool DoFindLoot(uint32 diff, BotAIMovement* movement, uint32 downMountID);
...
public:
    ...
    void UpdateFleeMovementByPVE(Unit* pMaster, Unit* pRefUnit, BotAIMovement* pMovement);
    void UpdateFleeMovementByPVP(Unit* pRefUnit, BotAIMovement* pMovement);
    void UpdateFleeMovementByPosition(Unit* pRefUnit, Position centerPos, float maxPosDist, BotAIMovement* pMovement);
    float CalcMaxFleeDistance(Unit* pRefUnit);
    void AddCruxFlee(uint32 durTime, Unit* pRefUnit, BotAIMovement* pMovement);
...
public:
    ...
    void UpdateIDLEMovement(BotAIMovement* pMovement);
...
public:
    ...
    void UpdateCruxMovement(BotAIMovement* pMovement);
...
public:
    ...
    bool UpdateTankTarget(BotAIMovement* pMovement);
...
public:
    ...
    void UpdateFly(Player* masterPlayer, uint32 groundMountID, BotAIMovement* pMovement);
...
public:
    ...
    bool ProcessMovetoUseGO(BotAIMovement* pMovement);
...
public:
    ...
    bool ProcessMovetoPosition(BotAIMovement* pMovement);
